<div class="fdk-footer">
  <div class="footer-content container">
    <ul>
      <li>
        <div class="fdk-logo">
          <a id="fdk-logo-link" href="/">
            <img src="/plugins/nodebb-theme-fdk/images/datalandsbyen-logo-white.svg" alt="Datalandsbyen Logo">
          </a>
        </div>
      </li>
    </ul>
    <ul>
      ...
      <li><a href="https://data.norge.no">[[fdk:footer.fdk]] <img class="fdk-text-icon" src="/plugins/nodebb-theme-fdk/images/icon-external-link-xs-negative.svg" alt="Åpne"></a></li>
      <li><a href="https://datafabrikken.norge.no">[[fdk:footer.datafabrikken]] <img class="fdk-text-icon" src="/plugins/nodebb-theme-fdk/images/icon-external-link-xs-negative.svg" alt="Åpne"></a></li>
      <li><a href="https://transportportal.no">[[fdk:footer.transportPortal]] <img class="fdk-text-icon" src="/plugins/nodebb-theme-fdk/images/icon-external-link-xs-negative.svg" alt="Åpne"></a></li>
    </ul>
    <ul>
      <li class="footer-title">
        <h6>
