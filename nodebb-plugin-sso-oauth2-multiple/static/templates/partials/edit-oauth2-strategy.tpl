	...
	<div class="row">
		...
		<div class="col-sm-6">
			<fieldset id="details">
				...
				<div class="mb-3">
					<label class="form-label" for="logoutUrl">Logout URL</label>
					<input type="text" id="logoutUrl" name="logoutUrl" title="Logout URL" class="form-control" placeholder="https://..." value="{./logoutUrl}">
				</div>
